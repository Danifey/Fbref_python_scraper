...
'''
html_text1 = requests.get('https://fbref.com/en/players/5ed9b537/Ibrahima-Konate').text
...
def scrape (soup, currPlayerList):
    playerStats = []
    ...
    try:
        ...
        file_path = 'SoupError.csv'
        # # creates list with the information relevant to the error 
        status = "failure"
        info = [playerName, datetime.datetime.now(), status]
        #print(errorInfo)
